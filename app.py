...
# ==========================================
# เตรียมข้อมูลให้ AI ทาย (เวอร์ชัน Auto-Detect ป้องกันแอปพัง 100%)
# ==========================================
try:
    ...
    try:
        ...
        expected_cols = ['Datetime', 'Global_active_power', 'Global_reactive_power', 'Voltage', 'Global_intensity', 'Sub_metering_1', 'Sub_metering_2', 'Sub_metering_3', 'Power_Lag1', 'Power_Lag24', 'Hour', 'DayOfWeek', 'IsWeekend']
